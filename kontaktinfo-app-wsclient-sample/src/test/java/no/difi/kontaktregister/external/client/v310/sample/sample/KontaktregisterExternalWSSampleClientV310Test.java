package no.difi.kontaktregister.external.client.v310.sample.sample;
...
/**
 * Sample client tests to demonstrate how to set up and use: Kontaktinfo webservice v3.1.0 / Oppslagstjenesten for kontakt- og reservasjonsregisteret v3.1.0.
 *
 ...
 */
public class KontaktregisterExternalWSSampleClientV310Test {
    ...
    public static void beforeClass() {
        ...
        if(serviceAddress == null) {
        	serviceAddress = "http://localhost:9988/kontaktinfo-web-external/ws-v3.1.0";
        }
        ...
        WSS4JInterceptorHelper.addWSS4JInterceptorsV310(jaxWsProxyFactoryBean);
